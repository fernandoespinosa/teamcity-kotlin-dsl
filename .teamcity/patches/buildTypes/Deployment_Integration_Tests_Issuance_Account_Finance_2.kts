...
To apply the patch, create a buildType with id = 'Deployment_Integration_Tests_Issuance_Account_Finance_2'
in the project with id = 'Tests_Integration', and delete the patch script.
*/
create(RelativeId("Tests_Integration"), BuildType({
    id("Deployment_Integration_Tests_Issuance_Account_Finance_2")
